IF( WIN32 )
        ...
        FIND_PATH(D3D10_LIBRARY d3d10.lib
                PATHS
                        "$ENV{DXSDK_DIR}/Lib/x86"
                DOC "The directory where d3d10.lib resides")

        FIND_PATH(D3DX10_LIBRARY d3dx10.lib
                PATHS
                        "$ENV{DXSDK_DIR}/Lib/x86"
                DOC "The directory where d3dx10.lib resides")

        FIND_PATH(D3DX10D_LIBRARY d3dx10d.lib
                PATHS
                        "$ENV{DXSDK_DIR}/Lib/x86"
                DOC "The directory where d3dx10d.lib resides")

        FIND_PATH(DXGI_LIBRARY DXGI.lib
                PATHS
                        "$ENV{DXSDK_DIR}/Lib/x86"
                DOC "The directory where DXGI.lib resides")

		SET( DX10_INCLUDES ${DX3D10_INCLUDE_PATH} ${DX3D10_INCLUDE_PATH} ${DXGI_INCLUDE_PATH} )	
