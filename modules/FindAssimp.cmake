...
IF( WIN32 )
	...
	IF(ASSIMP_DIR)
		...
		IF( MSVC10 )
			FIND_LIBRARY(ASSIMP_LIBRARY assimp.lib PATHS "${ASSIMP_DIR}\\lib\\assimp_release-dll_win32")
			FIND_LIBRARY(ASSIMP_DEBUG_LIBRARY assimp.lib PATHS "${ASSIMP_DIR}\\lib\\assimp_debug-dll_win32")
			SET(ASSIMP_LIBRARY_DIR "${ASSIMP_DIR}\\lib\\assimp_release-dll_win32")
		ENDIF( MSVC10 )
	
		SET(ASSIMP_LIBRARIES ${FBX_LIBRARY} ${FBX_DEBUG_LIBRARY})
